...
async def start(client, message):
    ...
    buttons = [
        [
            InlineKeyboardButton('Anime Channel', url='https://t.me/Anime_World_Territory'),
            InlineKeyboardButton('🧩 Source', url='https://github.com/DEVILTG/VCPlayerBot')
        ],
        [
...
async def repo_(client, message):
    buttons = [
        [
            InlineKeyboardButton('🧩 Repository', url='https://github.com/DEVILTG/VCPlayerBot'),
            InlineKeyboardButton('Anime Channel', url='https://t.me/Anime_World_Territory'),     
        ],
        [
